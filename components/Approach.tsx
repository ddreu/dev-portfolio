  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        absolute top-[50%] left-[50%] translate-x-[-50%] transalte-y-[-50%]
        "
        >
          {icon}
        </div>
        <h2
          className="dark:text-white opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4 font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-200
